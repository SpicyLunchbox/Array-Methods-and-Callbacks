...
if (finals2014[0]["Home Team Goals"] > finals2014[0]["Away Team Goals"]){
    console.log(`Winner is ${finals2014[0]["Home Team Name"]}`);
} else {
    console.log(`Winner is ${finals2014[0]["Away Team Name"]}`);
}
...
function getFinals(array) {
   const final_teams = array.filter(function(item){
...
function getYears(array, callback) {
    let years = callback(array).map(function(item){
        return item.Year;
    });
    return years;
}
